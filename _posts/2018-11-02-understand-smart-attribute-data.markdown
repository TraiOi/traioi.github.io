...
date:   2018-11-02 11:09:08 +0700
categories: drive
description: Giúp hiểu được các thuộc tính dữ liệu của ổ cứng theo chuẩn S.M.A.R.T
---
##### I. Giới thiệu
...
| 184 | **End-to-End error / IOEDC** | ![critical]({{ site.url }}/assets/img/critical.png) | **End-to-end data** là các dữ liệu được chuyển từ host system (ví dụ như RAM cache) đến SSD và ngược lại.<br />**Raw value:** Thống kê số lần LBA (Logical Block Address) tag (hay parity bit) không khớp trong quá trình truyền end-to-end data.<br />**Value:** luôn 100. |
| 185 | **Head Stability** | | |
| 186 | **Induced Op-Vibration Detection** | | |
| 187 | **Reported Uncorrectable Errors** | ![critical]({{ site.url }}/assets/img/critical.png) | **Raw value:** Hiển thị số lỗi không thể khôi phục bằng ECC.<br />**Value:** luôn 100. |
| 188 | **Command Timeout** | ![critical]({{ site.url }}/assets/img/critical.png) | |
| 189 | **High Fly Writes** | | |
...
| 196 | *Reallocation Event Count** | ![critical]({{ site.url }}/assets/img/critical.png) | |
| 197 | **Current Pending Sector Count** | ![critical]({{ site.url }}/assets/img/critical.png) | |
| 198 | **(Offline) Uncorrectable Sector Count[** | ![critical]({{ site.url }}/assets/img/critical.png) | |
| 199 | **UltraDMA CRC Error Count** | | |
| 200 | **Multi-Zone Error Rate** | | |
| 201 | **Soft Read Error Rate**<br /><br />**TA Counter Detected** | ![critical]({{ site.url }}/assets/img/critical.png) | |
